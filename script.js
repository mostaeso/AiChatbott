...
const API_KEY = "AIzaSyBS4LXVx4-ubWderskOJ4ZqPqbYBOZrjXE";
...
const handleOutgoingMessage = (e) => {
  ...
  const handleOutgoingMessageDiv =createMessageElement(messageContent, "user-message")
   handleOutgoingMessageDiv.querySelector(".message-text").textContent = userData.message;
   chatBody.appendChild(handleOutgoingMessageDiv);
   chatBody.scrollTo({top: chatBody.scrollHeight , behavior: "smooth"});
